...
tic
    ...
    for img_num=1:numPic-1
        ...
        ransac_sample_times = size(matched_points1,1);
...
cut_bias = 50;
result = result(resultRowSize-ROWS_IMG2+cut_bias:resultRowSize-abs(translateVal_y_sum)-cut_bias,cut_bias:resultColSize-cut_bias,:);
